    ...
    <div class="app">
        ...
        <footer>
                    ...
                    <div class="row">
                        <article class="footer__top-intro col-lg-5 col-md-4 col-sm-6">
                            ...
                            <div class="footer__top-intro-content">
                                ...
                                lượng nhất giúp người đọc có những cuốn sách hay nhất để đọc! <br> <br> Điện thoại:
                                0942785922 <br> Email: phatnhpc03775@fpt.edu.vn <br> Zalo: 0942785922 <br>
                            </div>
                        </article>
            ...
            <section class="footer__bottom">
                <div class="container">
                    <div class="row">
                        <span class="footer__bottom-content"> Thiết kế bởi team 8 </span>
                    </div>
                </div>
            </section>
        </footer>
